...
хранится в переменной pricePerDroid (создай и присвой). При посещении страницы, используя prompt,
...
if (question === 0) {
    ...
    alert(`Вы купили ${question} дроидов, на счету осталось ${credits} кредитов`);
}